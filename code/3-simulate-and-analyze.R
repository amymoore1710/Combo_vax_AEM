pacman::p_load(future.apply, Rcpp, dplyr, tidyr, purrr)
...
# ---------------------------------------------------------------
run_smoke_test <- TRUE   # set FALSE to skip and go straight to the full run

if (run_smoke_test) {
  message("Running smoke test (1 simulation, small n_children)...")

  test_params <- f.param(ve_infection = 0.10, ve_disease = 0.40,
                         ve_severity  = 0.60, ve_ct       = 0.10)

  test_raw <- simulate_trial(
    n_children = 20000, n_months, countries,
    test_params[["diarrhea_ir"]], test_params[["shigella_sub"]], other_sub,
    test_params[["sev_params"]], test_params[["other_sev_params"]],
    test_params[["shigella_quantity"]], other_quantity
  )
...
# ---------------------------------------------------------------
ve_params_list <- list(
  list(ve_infection = 0.10, ve_disease = 0.40, ve_severity = 0.60, ve_ct = 0.10),
  list(ve_infection = 0.00, ve_disease = 0.40, ve_severity = 0.60, ve_ct = 0.10),
  list(ve_infection = 0.20, ve_disease = 0.40, ve_severity = 0.60, ve_ct = 0.10),
  list(ve_infection = 0.10, ve_disease = 0.30, ve_severity = 0.60, ve_ct = 0.10),
  list(ve_infection = 0.10, ve_disease = 0.50, ve_severity = 0.60, ve_ct = 0.10),
  list(ve_infection = 0.10, ve_disease = 0.40, ve_severity = 0.40, ve_ct = 0.10),
  list(ve_infection = 0.10, ve_disease = 0.40, ve_severity = 0.80, ve_ct = 0.10),
  list(ve_infection = 0.10, ve_disease = 0.40, ve_severity = 0.60, ve_ct = 0.00),
  list(ve_infection = 0.10, ve_disease = 0.40, ve_severity = 0.60, ve_ct = 0.20)
)
...
for (i in seq_along(ve_params_list)) {
  ...
  params <- f.param(ve_infection = ve$ve_infection, ve_disease = ve$ve_disease,
                    ve_severity  = ve$ve_severity,  ve_ct      = ve$ve_ct)
  ...
  super_true_ve <- as.character(ve$ve_disease)
  ...
  analytic_true_ve <- compute_true_ve_by_site(
    score_params = sev_params2$score_params,
    gems_coefs   = sev_params2$gems_params$coefs,
    diarrhea_ir  = diarrhea_ir2,
    ve_max       = sev_params2$ve_max,
